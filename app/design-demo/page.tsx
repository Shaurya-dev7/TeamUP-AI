    ...
    <section className="relative overflow-hidden pt-32 pb-20 lg:pt-48 lg:pb-32">
      ...
      <div className="container relative z-10 px-4 mx-auto text-center">
        ...
        <motion.h1 
          ...
          className="max-w-4xl mx-auto mb-6 text-5xl font-bold tracking-tight text-neutral-900 dark:text-white sm:text-7xl"
        >
        ...
        >
             <div className="absolute inset-x-0 -bottom-1 h-32 bg-gradient-to-t from-white dark:from-black to-transparent z-20 pointer-events-none" />
...
function Marquee() {
  return (
    <div className="w-full py-10 overflow-hidden bg-neutral-50 dark:bg-neutral-900/50 border-y border-neutral-200 dark:border-neutral-800">
      <div 
        ...
        <footer className="py-12 border-t border-neutral-200 dark:border-neutral-800 bg-white dark:bg-black">
            <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
                <div className="mb-4 md:mb-0">
                    <span className="text-xl font-bold dark:text-white">Team<span className="text-yellow-500">Up</span></span>
                    <p className="text-sm text-neutral-500 mt-2">© 2024 TeamUp Inc.</p>
                </div>
                <div className="flex gap-6">
                    <a href="#" className="text-neutral-500 hover:text-neutral-900 dark:hover:text-white transition-colors">Twitter</a>
                    <a href="#" className="text-neutral-500 hover:text-neutral-900 dark:hover:text-white transition-colors">GitHub</a>
                    <a href="#" className="text-neutral-500 hover:text-neutral-900 dark:hover:text-white transition-colors">Discord</a>
                </div>
            </div>
        </footer>
    )
...
export default function DesignDemoPage() {
  return (
    <div className="min-h-screen bg-white dark:bg-black selection:bg-yellow-400/30">
        <Hero />
        <Marquee />
        <BentoGrid />
        <CTA />
