...
export function MagneticText({ text = "CREATIVE", hoverText = "EXPLORE", className }: MagneticTextProps) {
  ...
  return (
    ...
    >
      ...
      <span className="text-5xl font-bold tracking-tighter text-black dark:text-white tracking-wide">{text}</span>

      <div
        ref={circleRef}
        className="absolute top-0 left-0 pointer-events-none rounded-full bg-yellow-400 overflow-hidden"
        style={{
      ...
      >
        ...
        >
          <span className="text-5xl font-bold tracking-tighter text-white whitespace-nowrap tracking-wide">
            {hoverText}
          </span>
        </div>
      </div>
